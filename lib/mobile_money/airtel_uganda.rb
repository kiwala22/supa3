module MobileMoney
	class AirtelUganda
		...
		def self.check_transaction_status(ext_transaction_id)
			url = "http://172.27.77.135:9192/services/MFS?LOGIN=#{@@user_name}&PASSWORD=#{@@password}&REQUEST_GATEWAY_CODE=EXT001&REQUEST_GATEWAY_TYPE=EXTSYS"
