...
RSpec.describe Confirmation::AirtelUgandaController, type: :controller do
	describe "POST create" do
		it "returns status success for well formed request and saves collection" do
			...
			xml = "<?xml version='1.0' encoding='UTF-8'?><COMMAND><TYPE>STANPAY</TYPE><MOBTXNID>#{ext_id}</MOBTXNID><AMOUNT>15000</AMOUNT><REFERENCE>845</REFERENCE><BILLERCODE>TESTME</BILLERCODE><USERNAME>skyline</USERNAME><PASSWORD>skyline</PASSWORD><MSISDN>704422320</MSISDN></COMMAND>"
