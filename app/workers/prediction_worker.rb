class PredictionWorker
  ...
  def perform
    ...
    Gamer.left_outer_joins(:tickets).select(:id).where("tickets.created_at < ?", (Date.today.beginning_of_day - 90.days)).distinct.in_batches(of: 50000).update_all(supa3_segment: "G", supa5_segment: "G")
