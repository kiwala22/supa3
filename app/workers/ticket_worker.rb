class TicketWorker
   ...
   def process_ticket(phone_number, message, amount)
      ...
      if data.length == 3 #should also check that its below 10
         ticket = @@gamer.tickets.new(phone_number: @@gamer.phone_number, data: data, amount: amount.to_i, reference: reference, network: network, first_name: @@gamer.first_name, last_name: @@gamer.last_name, keyword: keyword, game: "Supa3")
         if ticket.save
         ...
         ticket = @@gamer.tickets.new(phone_number: @@gamer.phone_number, data: random_data, amount: amount.to_i, reference: reference, network: network, first_name: @@gamer.first_name, last_name: @@gamer.last_name, keyword: keyword, game: "Supa3")
         if ticket.save
